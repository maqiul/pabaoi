...
namespace pcbaoi
{
    public partial class ShieldForm : Form
    {
        ...
        private void Buzzerbt_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
        ...
        private void Buzzerbt_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
