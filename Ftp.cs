...
namespace pcbaoi
{
    ...
    {
        public static string ftpPath = @IniFile.iniRead("Ftp", "ftppath");
        public static string ftpUser = IniFile.iniRead("Ftp","user");
        public static string ftpPassword = IniFile.iniRead("Ftp", "password");
