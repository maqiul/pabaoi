...
namespace pcbaoi
{
    public partial class Barchart : UserControl
    {
        ...
        public Barchart(object ob)
        {
            ...
            operatorselect.Luminanceon = rangeTrackBarControl1.Value.Maximum;
            operatorselect.Luminancedown = rangeTrackBarControl1.Value.Minimum;
        ...
        private void draw() {
            using (Graphics gc = chart1.CreateGraphics())
            {
                ...
                if (rect.Contains(chart1.Location))
                {
                    ...
                    //画横线
                    gc.DrawLine(pen1, rangeTrackBarControl1.Value.Minimum * 8 + 35, 167, rangeTrackBarControl1.Value.Minimum * 8 + 35, 0);
                    gc.DrawLine(pen2, rangeTrackBarControl1.Value.Maximum * 8 + 35, 167, rangeTrackBarControl1.Value.Maximum *8 + 35, 0);
